...
Feature: Realizar el Pago en Linea en Web Somos Belcorp
  ...
  Scenario Outline: Pago en Linea Parcial Exitoso
    ...
    And Click en el desplegable de la opcion "Pago_Parcial"
    And Ingreso el MontoParcial "<Monto_Parcial>"
    And Click en el boton "ContinuarPagoParcial"
  ...
  Examples:
  | Pais       | Usuario   | Password | Monto_Parcial |  Home            | NombrePropietario | Tarjeta | NumeroDeTarjeta  | Mes_tarjeta_Pagadito  | Ano_tarjeta_Pagadito  | CCV_tarjeta_Pagadito  | Nombres_tarjeta_Pagadito  | Apellidos_tarjeta_Pagadito  | Direccion_tarjeta_Pagadito | Ciudad_tarjeta_Pagadito | PaisTarjeta | EstadoTarjeta | CodigoZipTarjeta |  TelefonoTarjeta | CelularTarjeta | EmailTarjeta | ContrasenaTarjeta |
  | Costa Rica | 2472511   | 1        |    546.00     | DETALLES DE PAGO | Prueba          | 1 | 4913407733624972 | 01                    | 2023                  | 123                   | Prueba                    | Prueba 2                    | Andalucia              | Castilla                   | España         | Madrid        | 15023                       | 3637018                    | 996149576                | test123@gmail.com              | prueba123 |
  | Costa Rica | 2472511   | 1        |    546.00     | DETALLES DE PAGO | Prueba          | 2 | 4913407733624972 | 02                    | 2023                  | 123                   | Prueba                    | Prueba 2                    | Andalucia              | Castilla                   | España         | Madrid        | 15023                       | 3637018                    | 996149576                | test123@gmail.com              | prueba123 |
